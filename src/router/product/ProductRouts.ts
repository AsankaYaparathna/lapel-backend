...
class ProductRouts extends BaseRoutes{
    public routes(): void {
        ...
        this.router.delete("/custom/option/delete/:id", ProductController.deleteCustomProductOption);
        this.router.get("/custom/option/getById/:id", ProductController.getCustomProductOption);
